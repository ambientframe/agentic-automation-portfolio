...
export default function PortfolioPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-14 space-y-16">
      <FrontDoor declaration={COMMERCIAL_DECLARATION} provenance={provenance} />

      <div id="evaluator-layer" className="space-y-16 scroll-mt-6">
        ...
        <MaturityLegend provenance={provenance} />
      </div>
    </div>
  );
}
