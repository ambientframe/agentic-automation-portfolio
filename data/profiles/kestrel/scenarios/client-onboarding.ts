 ...
 * fixture. System 3's own scenario file is NOT imported here; the coupling is matching
 * data, not a code dependency (see the handoff contract's doc comment in
...
const BRAMWELL_HANDOFF: SignedEngagementHandoff = {
  ...
  scopeSummary:
    'Security questionnaire remediation sprint: shore up gaps in the specific enterprise-prospect questionnaire and return a credible response within the buyer’s four-week window.',
  exclusions: ['A full SOC 2 Type I or Type II readiness program', 'Any certification, attestation, or audit opinion'],
  sellerCommitments: ['A completed, credible response to the specific questionnaire within approximately four weeks'],
  customerCommitments: ['Provide read-only access to in-scope systems for evidence gathering', 'Name a single accountable owner'],
  timing: '4 weeks',
  successCriteria: ["The buyer's procurement team accepts the completed questionnaire response"],
  stakeholders: [{ name: 'Priya Nandy', role: 'Head of Security — primary contact and next-step owner' }],
  ...
  knownUnknowns: ['budgetDiscussed — deferred to a CFO check on the original call, never re-opened here'],
