              ...
              effects: [
                {
                  ...
                  execution: { kind: 'SEND', attemptId: 'send-1', provider: 'test-provider', honorsIdempotencyKey: false },
                },
              ],
            },
          ],
        ...
        effects: [
          {
            ...
            policyPermits: true,
            execution: { kind: 'SEND' as const, attemptId, provider: 'test-provider', honorsIdempotencyKey: false },
          },
        ],
      });
        ...
        effects: [
          {
            ...
            authority: 3 as const,
            policyPermits: true,
            execution: { kind: 'SEND' as const, attemptId: 'send-1', provider: 'test-provider', honorsIdempotencyKey: false },
          },
        ],
      };
          ...
          effects: [
            {
              ...
              authority: 3 as const,
              policyPermits: true,
              execution: { kind: 'VERIFY' as const, attemptId: 'verify-1', targetIdempotencyKey: 'ack-1', provider: 'test-provider' },
            },
          ],
        },
        {
          ...
          effects: [
            {
              ...
              authority: 3 as const,
              policyPermits: true,
              execution: { kind: 'SEND' as const, attemptId: 'send-2', provider: 'test-provider', honorsIdempotencyKey: false },
            },
          ],
        },
      ];
