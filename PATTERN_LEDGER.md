...
- **Reusable for 2–6:** the shape is `resolveEscalationOwner(profile, assigneeCeiling + 1)` plus a routing-time assignment fact, and needs nothing Call-to-Proposal-specific. Any system that parks work with a named owner inherits it; Client Onboarding's readiness sign-off is the obvious next taker.
